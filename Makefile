...
# This variable is setup in the $(SNIFF_DIR)/make_support/$(PLATFORM).mk because
# it depends on the build mode (shared|static) but you can add additional libs here
#SUB_LIBS           = <other sub libs>
#
...
#OTHER_CXXFLAGS     = -DLOG_HIGH_TRACE #-DPURE_LEAK #<project dependent additional C++ compiler flags>
...
#DEBUG              = 1#<Default 0, Command line flag to print debug messages>
